...
const BookWidget=({book})=>{
    console.log(book.volumeInfo.categories);
    return (<div className="container book-card-design">
    <div className="card">
        <div className="card-body">
            ...
            <div className="row">
                <div className="col-lg-5 col-md-5 col-sm-6">
                    <div className="white-box text-center"><img src={ book.volumeInfo.hasOwnProperty("imageLinks")?book.volumeInfo.imageLinks.thumbnail:null} alt="Image Not FOund" className="img-responsive"/></div>
                </div>
                    ...
                    <div className="table-responsive">
                        <table className="table table-striped table-product">
                            ...
                            <tr>
                                ...
                                <tr>
                                    <td>ISBN</td>
                                    <td>{book.volumeInfo.hasOwnProperty("industryIdentifiers") ?book.volumeInfo.industryIdentifiers.map((elem)=>elem.identifier+", "):""}</td>
                                </tr>
                                <tr>
                                    <td>Categories</td>
